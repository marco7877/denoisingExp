...
This experiment was created using PsychoPy3 Experiment Builder (v2022.1.4),
    on Wed 28 Jun 2023 02:14:34 PM 
...
expName = 'sentenceTR1200'  # from the Builder filename that created this script
expInfo = {
    'participant': '',
    'session': '001',
}
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/mflores/Documents/denoisingExp/sentenceTR1200_lastrun.py',
...
text_14 = visual.TextStim(win=win, name='text_14',
    text='Veras oraciones. Por favor, leelas en voz alta cuando aparezca la cruz',
    font='Open Sans',
...
InstruccionesComponents = [text_14]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_13.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_13.tStartRefresh + 4.8-frameTolerance:
            # keep track of stop time/frame for later
...
# update component parameters for each repeat
# keep track of which components have finished
BacalaoComponents = [text, text_2, text_3]
...
# update component parameters for each repeat
# keep track of which components have finished
baldeComponents = [text_4, text_5, text_6]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_6.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_6.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
...
# update component parameters for each repeat
# keep track of which components have finished
fajitasComponents = [text_7, text_8, text_9]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_7.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_7.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if text_8.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_8.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if text_9.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_9.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
...
# update component parameters for each repeat
# keep track of which components have finished
mantequillaComponents = [text_10, text_11, text_12]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_10.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_10.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if text_11.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_11.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
    ...
    if text_12.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_12.tStartRefresh + 1.2-frameTolerance:
            # keep track of stop time/frame for later
